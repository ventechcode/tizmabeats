      ...
      <div className="flex flex-col sm:flex-row sm:justify-end items-start sm:items-center gap-4 mt-4 md:mt-0 w-full">
        ...
        <div className="flex items-center justify-end gap-2 md:gap-2 w-full">
          ...
          <Link
            ...
            className="p-2 bg-text text-crust rounded-lg hover:text-text hover:bg-crust duration-300 w-full ml-2 sm:w-auto mt-2"
          >
      ...
      <TableHeader columns={headerColumns}>
        {(column) => (
          <TableColumn
            ...
            className={
              column.sortable
                ? "hover:cursor-pointer hover:text-subtext0 w-12"
                : ""
            }
          >
            {column.name}
