  ...
  return (
    <div className="flex flex-col items-center justify-center max-w-[90%] md:max-w-[75%] lg:max-w-[70%] xl:max-w-[82%] mx-auto">
      ...
      <DashboardShell className="w-full mt-8 mb-8">
        ...
        <Suspense fallback={<DashboardTableSkeleton columns={5} rows={3} className="col-span-4" />}>
          <RecentBeats />
        </Suspense>
        <Suspense fallback={<DashboardTableSkeleton columns={3} rows={2} className="col-span-3" />}>
          <RecentOrders />
        </Suspense>
        <Suspense fallback={<DashboardTableSkeleton columns={3} rows={2} className="col-span-1" />}>
          <TopProducers />
        </Suspense>
      </DashboardShell>
    </div>
